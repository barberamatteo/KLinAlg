...
class GradientDescentSolverTest {
    ...
    fun spa1_10en4(){
        ...
        val rightHandSide = m * Matrix.xFilledVector(m.cols, 1.0, true)
        val sol = solver.solve(m, 10e-4, 20000, rightHandSide)
        println(sol)
    }
    ...
    fun spa1_10en6(){
        val m = parse("src/test/resources/dati/spa1.mtx")
        val rightHandSide = m * Matrix.xFilledVector(m.cols, 1.0, true)
        val sol = solver.solve(m, 10e-6, 20000, rightHandSide)
        println(sol)
    }
    ...
    fun spa1_10en8(){
        val m = parse("src/test/resources/dati/spa1.mtx")
        val rightHandSide = m * Matrix.xFilledVector(m.cols, 1.0, true)
        val sol = solver.solve(m, 10e-8, 20000, rightHandSide)
        println(sol)
    }
    ...
    fun spa1_10en10(){
        val m = parse("src/test/resources/dati/spa1.mtx")
        val rightHandSide = m * Matrix.xFilledVector(m.cols, 1.0, true)
        val sol = solver.solve(m, 10e-10, 20000, rightHandSide)
        println(sol)
    }
